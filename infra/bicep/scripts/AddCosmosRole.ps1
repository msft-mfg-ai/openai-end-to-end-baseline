# ------------------------------------------------------------------------------------
# Manually assign Data Contributor Role in a Cosmos Database for one principal
# You must supply the Cosmos Database Name, the Resource Group it lives in, and the Principal Id that needs access
# Example Usage:
