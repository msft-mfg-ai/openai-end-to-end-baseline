...
output UI_CONTAINER_APP_FQDN string = deployAPIApp ? containerAppUI.outputs.fqdn : ''
output UI_CONTAINER_APP_NAME string = deployAPIApp ? containerAppUI.outputs.name : ''
